...
@pytest.mark.parametrize(
    ...
    [
        ...
        (example_dict, "w", None, ["/a/b/j/0/w"]),
        (example_dict, "full", example_dict, []),
        ({"a": {"7": 9.876554}}, "7", 9.876554, ["/a/'7'"]),
        ({"a": [{"7": 9.876554}]}, "7", 9.876554, ["/a/0/'7'"]),
    ],
)
def test_search_pair_success(dict_, key, value, response):
    rdict = Rdict(dict_)
